...
type User struct {
	...
	Student      *StudentProfile `gorm:"constraint:OnDelete:SET NULL;foreignKey:UserID"`
	Teacher      *TeacherProfile `gorm:"constraint:OnDelete:SET NULL;foreignKey:UserID"`
	Staff        *StaffProfile   `gorm:"constraint:OnDelete:SET NULL;foreignKey:UserID"`
	RefreshToken *RefreshToken   `gorm:"constraint:OnDelete:CASCADE;foreignKey:UserID"`
}
...
type StudentProfile struct {
	...
	Group   *Group     `gorm:"constraint:OnDelete:SET NULL;foreignKey:GroupID;references:ID"`
}
